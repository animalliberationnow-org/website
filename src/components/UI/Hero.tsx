...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="relative flex items-center min-h-[60vh] lg:min-h-[80vh] bg-primary text-text-main overflow-hidden border-b border-glass-border">
      ...
      <div className="absolute inset-0 z-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-transparent to-primary/40 dark:from-primary/25 dark:via-primary/50 dark:to-primary/90" />
      ...
      <div className="container-custom relative z-20 pt-32 pb-16">
        <div className={`max-w-4xl relative ${centered ? "mx-auto text-center" : ""} p-4 md:p-6`}>
          ...
          {subtitle && (
            <p
              className="text-lg md:text-xl mb-10 animate-slide-up text-text-muted font-medium max-w-2xl mx-auto drop-shadow-md"
