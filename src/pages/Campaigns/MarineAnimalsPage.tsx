...
const MarineAnimalsPage = () => {
  return (
    <div className="bg-primary min-h-screen">
      <Hero
        title="Fish & Marine Animals"
        subtitle="The oceans are being emptied. Trillions of sentient marine animals are pulled from the water every year in silent agony."
        ...
        <div className="max-w-6xl mx-auto relative z-10 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-5xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white">2.7T</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">Marine animals caught from the wild each year.</p>
            </div>
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-3xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white break-words mt-3">BYCATCH</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">Millions of dolphins, turtles, and sharks killed as 'accidental' catch.</p>
            </div>
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-2xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white mt-4">SUFFOCATION</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">Fish are not protected by humane slaughter laws and slowly suffocate.</p>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section dark={false}>
        ...
        <div className="glass-panel p-12 max-w-4xl mx-auto text-center shadow-neon">
          <p className="text-xl text-text-muted leading-relaxed font-medium">
            Fish are often the forgotten victims of human exploitation. ALN! actively campaigns to include marine animals in our circles of compassion. Our street activism highlights the sentience of fish and the devastating environmental impact of commercial fishing.
          </p>
        </div>
      </Section>
            ...
            <div className="bg-primary-light p-12 flex flex-col md:flex-row items-center justify-between gap-12 rounded-[2.5rem]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                ...
                <Link to="/support" className="btn btn-primary text-sm flex items-center justify-center">
                  Amplify Voice <HiArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </div>
            </div>
          </div>
...
export default MarineAnimalsPage;
