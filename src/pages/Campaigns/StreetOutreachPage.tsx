...
const StreetOutreachPage = () => {
  return (
    <div className="bg-primary min-h-screen">
      <Hero
        title="Street Outreach"
        subtitle="We take the truth to the streets. Face-to-face activism is the most powerful tool we have to break public conditioning."
        ...
        <div className="max-w-6xl mx-auto relative z-10 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-3xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white mt-3">CONDITIONING</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">Most people oppose animal cruelty, but are disconnected from what they buy.</p>
            </div>
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-3xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white mt-3">DIRECT ACTION</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">Street outreach confronts the public directly with the victims' reality.</p>
            </div>
            <div className="glass-panel p-10 group text-center hover:-translate-y-2">
              <h3 className="text-3xl font-black mb-6 text-text-main group-hover:text-accent transition-colors drop-shadow-glow-white mt-3">IMPACT</h3>
              <p className="text-text-muted font-medium text-sm uppercase tracking-widest leading-relaxed">A 5-minute conversation can plant the seed for lifelong behavioral change.</p>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section dark={false}>
        ...
        <div className="glass-panel p-12 max-w-4xl mx-auto text-center shadow-neon">
          <p className="text-xl text-text-muted leading-relaxed font-medium">
            ALN! hosts weekly outreach events—such as Cubes of Truth and Circles of Justice—in high-foot-traffic areas. Our volunteers are trained to engage the public in Socratic dialogue, ensuring conversations are impactful and thought-provoking rather than confrontational.
          </p>
        </div>
      </Section>
          ...
          <div className="glass-panel p-1 border-accent/30 shadow-neon">
            <div className="bg-primary-light p-12 flex flex-col md:flex-row items-center justify-between gap-12 rounded-[2.5rem]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                <Link to="/resources/activists" className="btn btn-outline text-sm">
                  View Resources
                </Link>
                <Link to="/support" className="btn btn-primary text-sm flex items-center justify-center">
                  Attend Workshop <HiArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </div>
            </div>
          </div>
...
export default StreetOutreachPage;
